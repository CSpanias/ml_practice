...
Compared the accuracy of four different Logistic Regression models.
"""
...
# check how many rows and colums the features and target have 
...
#everything in cm already, thus, won't change much(?)
